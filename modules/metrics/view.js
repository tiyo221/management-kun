...
(function () {
  ...
  function itemRow(m, depth) {
    ...
    // depth ぶんインデントして KGI→NSM→KPI の階層を視認できるようにする（幅は .mk-indent が持つ。wbs のツリーと共通）。
    const grow = el("div", { class: "grow mk-indent", style: "--mk-depth:" + depth + ";" }, [title, el("div", { class: "sub" }, meta)]);
