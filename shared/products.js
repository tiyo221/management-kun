  ...
  const products = {
    ...
    create(attrs) {
      ...
      const p = Object.assign(
        { id: MK.util.uid("prod"), name: "", status: "planned", owner: "", summary: "", repo: "", tags: [], createdAt: now, updatedAt: now },
        attrs || {}
      );
     ...
     */
    replaceAll(list) {
      persist({ version: 1, products: Array.isArray(list) ? list : [] });
    },
     ...
     */
    buildCSVRows() {
      const rows = [["プロダクト名", "ステータス", "責任者", "概要", "リポジトリ", "タグ"]];
